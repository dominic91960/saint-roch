...
const FeaturedProducts = () => {
  return (
    <section className="bg-[rgb(240,240,240)] text-[12px] sm:text-[15px] md:text-[18px] lg:text-[21px] xl:text-[24px] 2xl:text-[24px] mb-[4em]">
      <motion.div
        variants={SlideLeft(0.5)}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
        className="section-padding container mx-auto pt-[2em] pb-[2em]"
      >
